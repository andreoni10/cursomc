...
import com.example.mc.domain.ItemPedido;
import com.example.mc.domain.Pagamento;
import com.example.mc.domain.PagamentoComBoleto;
import com.example.mc.domain.PagamentoComCartao;
import com.example.mc.domain.Pedido;
import com.example.mc.domain.Produto;
import com.example.mc.domain.enums.EstadoPagamento;
...
import com.example.mc.repositories.ItemPedidoRepository;
import com.example.mc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void InstantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "m@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
